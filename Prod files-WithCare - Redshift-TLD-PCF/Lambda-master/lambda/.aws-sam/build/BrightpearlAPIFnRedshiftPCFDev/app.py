...
def main(logins_to_handle):
    ...
    try:
        ...
        for schema_to_handle in logins_to_handle:           
            ...
            pcf=BrightpearlIntegrationInteraction(log, BrightpearlModule.PRODUCTCUSTOMFIELD, b1, conn_context)
            ...
            pcf.persist_module_segment_truncation()
            # cm.run_truncate_tbl()
...
if __name__ == '__main__':
    ...
    lambda_handler(json.loads("{\"login\": [\"brightpearl_troyleedesigns\"]}"), "NULL")
