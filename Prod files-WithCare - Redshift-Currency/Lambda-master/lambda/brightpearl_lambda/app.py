...
def main(logins_to_handle):
    ...
    try:
        ...
        for schema_to_handle in logins_to_handle:           
            ...
            cr=BrightpearlIntegrationInteraction(log, BrightpearlModule.CURRENCY, b1, conn_context)
            ...
            # cf.persist_module_segment_truncation()
            cr.persist_module_segment_truncation()
...
if __name__ == '__main__':
    ...
    lambda_handler(json.loads("{\"login\": [\"brightpearl_yeti\"]}"), "NULL")
