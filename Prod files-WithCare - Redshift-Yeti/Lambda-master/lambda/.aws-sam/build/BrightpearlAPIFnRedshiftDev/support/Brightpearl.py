        ...
        if module_info["is_bridge_table"] == False:                                
            ...
            while more_results == True:
                if tablename=="customerpayment":    
                    ...
                    print("Not in CP")
                    parameters = {"columns":module_info["Id"]
                                                ,"updatedOn": time_from + "/" +now#>yeti max inventory date
                                                ,"firstResult": current_result}
            ...
            if self.entity is BrightpearlModule.PRODUCTAVAILABILITY:
                ...
                for contact in list_with_details:
                    ...
                    entities_to_insert.append({
                                ...
                                ,"postaddressid_bil":contact["postAddressIds"]["BIL"] if "BIL" in contact["postAddressIds"] else 0
                                ,"postaddressid_def":contact["postAddressIds"]["DEF"] if "DEF" in contact["postAddressIds"] else 0
                                ,"postaddressid_del":contact["postAddressIds"]["DEL"] if "DEL" in contact["postAddressIds"] else 0
                        }) 
                ...
                for order in list_with_details:
                    ...
                    entities_to_insert.append({
                                ...
                                ,"delivery_address_line_1": order["parties"]["delivery"]["addressLine1"] if "delivery" in order["parties"] and "addressLine1" in order["parties"]["delivery"] else "NA"
                                ,"delivery_address_line_2": order["parties"]["delivery"]["addressLine2"] if "delivery" in order["parties"] and "addressLine2" in order["parties"]["delivery"] else "NA"
                                ,"delivery_address_city": order["parties"]["delivery"]["addressLine3"] if "delivery" in order["parties"] and "addressLine3" in order["parties"]["delivery"] else "NA"
                                ,"delivery_address_province": order["parties"]["delivery"]["addressLine4"] if "delivery" in order["parties"] and "addressLine4" in order["parties"]["delivery"] else "NA"
                                ,"delivery_address_postalcode": order["parties"]["delivery"]["postalCode"] if "delivery" in order["parties"] and "postalCode" in order["parties"]["delivery"] else "NA"
